...
class WorkflowInstance(models.Model):
    ...
    def execute_workflow(self):
        for task_instance in self.task_instances.all():
    ...
    def execute_http_task(self, task_instance):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                task_instance.save()
                print(f"HTTP request failed for task {task_instance.task_definition.name} with status code {response.status_code}")
